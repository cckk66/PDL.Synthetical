...
namespace PDL.Synthetical.TokenManager
{
    ...
    public static class SecurityManager
    {
        ...
        private static int _expirationMinutes = Tools.ticksTools;

        public static string GenerateToken(string userName, string passWrod, string v, string userAgent, object ticks)
        {
