...
namespace PDL.Synthetical.Common
{
    ...
    public class CacheHelper
    {
        ...
        public static void SetCache(string CacheKey, object objObject, DateTime.MaxValue)
        {
            System.Web.Caching.Cache objCache = HttpRuntime.Cache;
            objCache.Insert(CacheKey, objObject, null, DateTime.MaxValue, System.Web.Caching.Cache.NoSlidingExpiration);
        }
